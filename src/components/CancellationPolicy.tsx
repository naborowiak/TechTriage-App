...
export const CancellationPolicy: React.FC<Props> = ({ onBack }) => (
  <div className="min-h-screen bg-light-50 dark:bg-midnight-950 pt-24 pb-12 px-6">
    <div className="max-w-3xl mx-auto bg-white dark:bg-midnight-800 rounded-2xl border border-light-300 dark:border-midnight-700 p-8 md:p-12">
      <button onClick={onBack} className="flex items-center gap-2 text-text-secondary hover:text-text-primary dark:hover:text-white mb-8 transition-colors">
        <ArrowLeft className="w-4 h-4" /> Back to Home
      </button>

      <h1 className="text-3xl font-bold text-text-primary dark:text-white mb-2">Cancellation & Refund Policy</h1>
      ...
      <div className="prose dark:prose-invert max-w-none text-text-secondary space-y-6">
        <section>
          <h2 className="text-xl font-bold text-text-primary dark:text-white mb-3">1. Cancel Anytime</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary dark:text-white mb-3">2. Prorated Refunds (Upgrades & Downgrades)</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-text-primary dark:text-white mb-3">3. Refund Policy</h2>
