...
export const FAQ: React.FC<FAQProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-screen pt-[64px] transition-colors" style={{ backgroundImage: 'url(/gradient-poly.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      {/* Hero Section */}
      ...
      {/* Category Pills */}
      <div className="bg-white dark:bg-midnight-900 border-b border-surface-border dark:border-midnight-700 sticky top-[64px] z-40">
