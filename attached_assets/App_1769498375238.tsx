...
import { 
  Menu, X, CheckCircle2, ArrowRight, Shield, Video, 
  MessageSquare, Cpu, Smartphone, Calendar, Lock, 
  Zap, Wrench, PenTool, Home, Star, Play, Sparkles,
  LifeBuoy, Search, AlertTriangle, Droplet, Tv, Wifi,
  User
} from 'lucide-react';
